...
right = \relative c'' {
  ...
  aes8-_\( r8 aes16( bes c des c8.)-_ aes-_ bes8-_\) |
  ...
  8 c\) r8 \small bes='16( c-5 bes-3 aes-2 \change Staff = "left" \clef "treble" e-1 ees des8) \change Staff = "right" \normalsize ees'=''16-5\( f, |

  ees'=''16 f, des' f, des'-4 f, c'-5 f, c'8. bes aes8 |
  <c-4 g>8. <bes-3 f>16 ~ q8\) \ottava 1 \small \acciaccatura fis''8-3 g='''8-5 ees4-2 \ottava 0 \normalsize r8 ees,=''16\( g, |
  ees'=''16 g, des' g, des' g, c g c8. bes aes8 |
  <bes g>8. <aes f>16 ~ q4\) r8. c=''\( aes'8 |

  << { \voiceOne
      g=''8. aes ees8 ~ 8\) r8 ees\( aes |
      g8. aes ees8 r8 ees-3 f-5 ees16-3 16-5 ~ |
