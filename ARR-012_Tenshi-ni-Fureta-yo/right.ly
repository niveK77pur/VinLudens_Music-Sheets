...
right = \absolute {
  ...
  es''-3 c''-1 g''-5 es''-2 \change Staff = "left" \stemUp a''-1 g''-3] } \change Staff = "right" \stemNeutral \cadenzaOff \partial 4 c'''8[-3 a''-1] | 
  ...
  \bar "||"
  8\) <bes'' f'''>8\( <es''' bes'''> <es''' bes'''>8 ~ 8\) <bes'' f'''>\( <es''' bes'''> <f''' c''''>8 ~ |
  ...
  \shape #'((0 . 4) (6 . -3) (-3 . 0) (0 . 3)) Slur d''8-5_( bes' fis' \once\override Beam.positions = #'(-5 . -4) d' \change Staff = "left" bes fis |
  ...
  \ottava 1 \shape #'((0 . 0) (0 . 0) (0 . 1) (0 . 0)) Slur bes'''( f''' d''' \change Staff = "left" \clef "treble^8" bes'' f'' bes') | \change Staff = "right"
  \shape #'((0 . 0) (0 . 0) (0 . 1) (0 . 0)) Slur d''''( bes''' f''' d''' \change Staff = "left" \clef "treble^8" bes'' f'') | \change Staff = "right" \once\override Staff.OttavaBracket.padding = #3
  \ottava 2 \shape #'((0 . 0) (0 . 0) (0 . 1.5) (0 . 0)) Slur f''''( d'''' bes''' f''' \change Staff = "left" \clef "treble^15" d''' bes'') | \change Staff = "right"
